...
?>
<h4 class="title title--density-cozy title--level-4 typography typography--weight-light with-color with-color--color-darkest sg-margin-top-large"><?php esc_html_e( 'Useful Links', 'sg-central' ) ?></h4>
					...
					<div class="flex flex--align-center flex--gutter-none flex--direction-row flex--margin-none">
						<div class="box box--direction-row box--sm-9">
							<h6 class="title title--density-cozy title--level-6 typography typography--weight-bold with-color with-color--color-dark">
								<?php
								if ( $is_shop ) {
									esc_html_e( 'USE OUR WOOCOMMERCE STARTER FOR AN EASIER START!', 'sg-central' );
								} else {
									esc_html_e( 'USE OUR WORDPRESS STARTER FOR AN EASIER START!', 'sg-central' );
								}
								?>
							</h6>
							<p class="text text--size-medium typography typography--weight-regular with-color with-color--color-dark">
								<?php
								if ( $is_shop ) {
									esc_html_e( 'Our WooCommerce Starter allows you to choose a fancy design and add plugins with important functionality for your site. It installs and sets up all the items you chose.', 'sg-central' );
								} else {
									esc_html_e( 'Our WordPress Starter allows you to choose a fancy design and add plugins with important functionality for your site. It installs and sets up all the items you chose.', 'sg-central' );
								}
								?>
							</p>
							<a href="<?php echo admin_url( 'index.php?page=siteground-wizard' ); ?>" class="link sg-margin-top-x-small">
								<?php esc_html_e( 'Start Now', 'sg-central' ); ?>
							</a>
						</div>
			...
			<div class="container container--padding-none container--elevation-1 with-padding with-padding--padding-top-x-small with-padding--padding-left-large with-padding--padding-right-x-small with-padding--padding-bottom-large">
				<div class="flex flex--align-center flex--gutter-none flex--direction-row flex--margin-none">
					<div class="box box--sm-9">
						<h6 class="title title--density-cozy title--level-6 typography typography--weight-bold with-color with-color--color-dark">
							<?php esc_html_e( 'Take advantage of our WordPress Tutorial!', 'sg-central' ); ?>
						</h6>
						<p class="text text--size-medium typography typography--weight-regular with-color with-color--color-dark">
							<?php esc_html_e( 'We have prepared an easy to follow tutorial with everything you need to know about setting up your WordPress site, creating posts and pages, making backups and a lot more.', 'sg-central' ) ?>
						</p>
						<a href="<?php _e( 'https://www.siteground.com/tutorials/wordpress/', 'sg-central' ) ?>" target="_blank" class="link sg-margin-top-x-small">
							<?php esc_html_e( 'View WordPress Tutorial', 'sg-central' ); ?>
						</a>
					</div>
					<div class="box box--sm-3 typography--align-center">
						<span class="icon sg--hide-mobile" style="width: 80px">
		...
		<div class="box box--sm-6 with-padding with-padding--padding-top-none mobile-side-reset mobile-space-reset ">
			<div class="container container--padding-none container--elevation-1 with-padding with-padding--padding-top-x-small with-padding--padding-left-large with-padding--padding-right-x-small with-padding--padding-bottom-large">
				<div class="flex flex--gutter-none flex--direction-row flex--margin-none">
					<div class="box box--sm-9">
						<h6 class="title title--density-cozy title--level-6 typography typography--weight-bold with-color with-color--color-dark">
							<?php esc_html_e( 'Visit our WordPress Knowledge Base', 'sg-central' ); ?>
						</h6>
						<p class="text text--size-medium typography typography--weight-regular with-color with-color--color-dark">
							<?php esc_html_e( 'If you have a how to question about WordPress it’s quite likely that we already have the answer for you in our Knowledge Base. It contains more than 1000 helpful articles.', 'sg-central' ) ?>
						</p>
						<a href="<?php _e( 'https://www.siteground.com/kb/', 'sg-central' ) ?>" target="_blank" class="link sg-margin-top-x-small">
							<?php esc_html_e( 'Visit Knowledge Base', 'sg-central' ); ?>
						</a>
					</div>
					<div class="box box--sm-3 typography--align-center">
						<span class="icon sg--hide-mobile" style="width: 80px">
				...
				<div class="flex flex--gutter-none flex--direction-row flex--margin-none">
					<div class="box box--sm-9">
						<h6 class="title title--density-cozy title--level-6 typography typography--weight-bold with-color with-color--color-dark">
								<?php
								if ( $is_shop ) {
									esc_html_e( 'Read our WooCommerce Ebooks', 'sg-central' );
								} else {
									esc_html_e( 'Read our WordPress Ebooks', 'sg-central' );
								}
								?>
						</h6>
						<p class="text text--size-medium typography typography--weight-regular with-color with-color--color-dark">
								<?php
								if ( $is_shop ) {
									esc_html_e( 'Our top experts have shared their know how on WooCommerce in а specialized ebook. Take advantage of their knowledge and make your site faster and safer.', 'sg-central' );
								} else {
									esc_html_e( 'Our top experts have shared their know how on WordPress in specialized ebooks on different topics. Take advantage of their knowledge and make your site faster and safer.', 'sg-central' );
								}
								?>
						</p>
						<?php if ( $is_shop ): ?>
							<a href="<?php _e( 'https://www.siteground.com/woocommerce-ebook?utm_source=wpdashboard', 'sg-central' ) ?>" target="_blank" class="link sg-margin-top-x-small">
						<?php else: ?>
							<a href="<?php _e( 'https://www.siteground.com/wordpress-speed-optimization-ebook?utm_source=wpdashboard&utm_campaign=ebookwpspeed', 'sg-central' ) ?>" target="_blank" class="link sg-margin-top-x-small">
						<?php endif ?>
							<?php esc_html_e( 'Get the Latest Ebook', 'sg-central' ) ?>
						</a>
					</div>
					<div class="box box--sm-3 typography--align-center">
						<span class="icon sg--hide-mobile" style="width: 80px">
